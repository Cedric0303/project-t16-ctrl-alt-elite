...
## Database Access
<p> Connection String (using MongoDB Compass): [mongodb+srv://<username>:<password>@ctrl-alt-elite.ys2d9.mongodb.net/test](mongodb+srv://<username>:<password>@ctrl-alt-elite.ys2d9.mongodb.net/test) </p>
